...
public class SyslogAppenderBuilder extends AbstractBuilder implements AppenderBuilder {
    ...
    public Appender parseAppender(final Element appenderElement, final XmlConfiguration config) {
        ...
        return createAppender(
                ...
                protocol.get(),
                header.get(),
                facilityPrinting.get(), new AppenderConfiguration(
                        name,
                        layout.get(),
                        filter.get(),
                        level.get()));
    ...
    public Appender parseAppender(
        ...
        return createAppender(
                ...
                header,
                facilityPrinting, new AppenderConfiguration(
                        name,
                        layout,
                        filter,
                        level));
    ...
    private Appender createAppender(
            ...
            final boolean facilityPrinting, org.apache.log4j.builders.appender.AppenderConfiguration appenderConfiguration) {
        final AtomicReference<String> host = new AtomicReference<>();
        final AtomicInteger port = new AtomicInteger();
        resolveSyslogHost(syslogHost, host, port);
        final org.apache.logging.log4j.core.Layout<? extends Serializable> messageLayout = LayoutAdapter.adapt(appenderConfiguration.getLayout());
        ...
        final org.apache.logging.log4j.core.Filter fileFilter = buildFilters(appenderConfiguration.getLevel(), appenderConfiguration.getFilter());
