...
public class RollingFileAppenderBuilder extends AbstractBuilder implements AppenderBuilder {
    ...
    public Appender parseAppender(final Element appenderElement, final XmlConfiguration config) {
        ...
        return createAppender(
                ...
                fileName.get(),
                maxSize.get(),
                maxBackups.get(), new AppenderConfiguration(
                        name,
                        layout.get(),
                        filter.get(),
                        level.get()));
    ...
    public Appender parseAppender(
        ...
        return createAppender(
                ...
                fileName,
                maxSize,
                maxBackups, new AppenderConfiguration(
                        name,
                        layout,
                        filter,
                        level));
    ...
    private Appender createAppender(
            ...
            final String maxBackups, org.apache.log4j.builders.appender.AppenderConfiguration appenderConfiguration) {
        final org.apache.logging.log4j.core.Layout<?> fileLayout = LayoutAdapter.adapt(appenderConfiguration.getLayout());
        if (!bufferedIo) {
