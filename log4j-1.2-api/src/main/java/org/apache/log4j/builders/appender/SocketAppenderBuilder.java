...
public class SocketAppenderBuilder extends AbstractBuilder implements AppenderBuilder {
    ...
    private <T extends Log4j1Configuration> Appender createAppender(
        ...
        final org.apache.logging.log4j.core.Layout<?> actualLayout = LayoutAdapter.adapt(appenderConfiguration.getLayout());
        final org.apache.logging.log4j.core.Filter actualFilter = buildFilters(appenderConfiguration.getLevel(), appenderConfiguration.getFilter());
        // @formatter:off
    ...
    public Appender parseAppender(
        ...
        return createAppender(
                ...
                configuration, new AppenderConfiguration(
                        name,
